...
// Migration function – creates the database structure if needed.

func MigrateDB(db *sql.DB) error {
	queries := []string{
		// Master table for user types
		...
		// Master table for display types
		...
		// OTP Requests table – note the generated column for valid_till
